...
var itemsToRemoveAndHide = [
    ...
    <item:farmersdelight:flint_knife>, <item:farmersdelight:iron_knife>, <item:farmersdelight:golden_knife>, <item:farmersdelight:diamond_knife>, <item:farmersdelight:netherite_knife>,
    <item:archers_paradox:training_arrow>, <item:archers_paradox:challenge_arrow>] as ItemDefinition[];
